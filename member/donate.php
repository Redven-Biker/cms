    ...
    <div class="standard-section section-portfolio" id="gallery" style="padding-top:10%">
        <div class="container">
            <div class="text-center">
                <h2 class="standard-header" data-100p-top="transform[swing]:translateX(25px);opacity[swing]:0" data-75p-top="transform[swing]:translateX(0);opacity[swing]:1"><?php echo $data['donate_text_section']; ?></h2>
            </div>
            ...
            <?php $reponse = $bdd->query('SELECT * FROM donate ORDER BY id DESC'); while ($data = $reponse->fetch()) { ?>
                                ...
                                <div class="portfolio-caption-outer">
                                    ...
                                    <div class="portfolio-caption-inner">
                                        ...
                                        <ul class="list-inline">
                                            <li>
                                                <a href="<?php echo $data['url']; ?>" title="<?php echo $data['title']; ?>" target="_blank"><button type="button" class="btn btn-warning">Donate</button></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
