    ...
    <div class="standard-section section-gray section-timeline" id="timeline" style="padding-top:10%">
        <div class="container">
            <div class="text-center">
                <h2 class="standard-header" data-100p-top="transform[swing]:translateX(25px);opacity[swing]:0" data-75p-top="transform[swing]:translateX(0);opacity[swing]:1"><?php echo $data['blog_text_section']; ?></h2>
            </div>
            <div class="timeline no-margin">
            <?php } $reponse->closeCursor(); ?>
            <?php $reponse = $bdd->query('SELECT * FROM blog ORDER BY id DESC'); while ($data = $reponse->fetch()) { ?>
                <div class="timeline-block">
                    ...
                    <div class="timeline-content" data-100p-top="transform[swing]:translateX(50px);opacity[swing]:0" data-75p-top="transform[swing]:translateX(0);opacity[swing]:1">
                        <a href="view-blog.php?id=<?php echo $data['id'];?>" class="frame"></a>
