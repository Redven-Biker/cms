...
if (strlen($_SESSION['id']==0)) {
  header('location:assets/libs/logout.php');
    ...
    if(isset($_POST['Submit']))
    {
      ...
      $id=intval($_GET['id']);
      $reponse = $bdd->query("UPDATE faq set title='$title', description='$description' where id='$id'");
    $_SESSION['msg']="Updated";
    }?>
<?php $reponse = $bdd->query("SELECT * from faq WHERE id='".$_GET['id']."'"); while ($data = $reponse->fetch()) { ?>
        <div id="page-wrapper" >
		  <div class="header"> 
