...
if (strlen($_SESSION['id']==0)) {
  header('location:assets/libs/logout.php');
    ...
    if(isset($_POST['Submit']))
    {
      ...
      $id=intval($_GET['id']);
      $reponse = $bdd->query("UPDATE vote set title='$title', img='$img', url='$url', description='$description' where id='$id'");
    $_SESSION['msg']="Updated";
    }?>
<?php $reponse = $bdd->query("SELECT * from vote WHERE id='".$_GET['id']."'"); while ($data = $reponse->fetch()) { ?>
        <div id="page-wrapper" >
		  <div class="header"> 
    ...
    <form class="col s12" method="post" action="">
      ...
      <div class="row">
        <div class="input-field col s12">
          <h5>URL</h5>
					<textarea id="textarea1" name="url" class="materialize-textarea"><?php echo $data['url']; ?></textarea>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
