    ...
    <div class="standard-section section-gray section-timeline" id="timeline" style="padding-top:10%">
        <div class="container">
            <div class="text-center">
                <h2 class="standard-header" data-100p-top="transform[swing]:translateX(25px);opacity[swing]:0" data-75p-top="transform[swing]:translateX(0);opacity[swing]:1"><?php echo $data['news_text_section']; ?></h2>
            </div>
            ...
            <?php $reponse = $bdd->query('SELECT * FROM news ORDER BY id DESC'); while ($data = $reponse->fetch()) { ?>
                <div class="timeline-block">
                    ...
                    <div class="timeline-content" data-100p-top="transform[swing]:translateX(50px);opacity[swing]:0" data-75p-top="transform[swing]:translateX(0);opacity[swing]:1">
                        <a href="view-news.php?id=<?php echo $data['id'];?>" class="frame"></a>
